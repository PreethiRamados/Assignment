...
public class FriendFinder {
	...
	public static void main(String[] args) {
		...
		if (locationFriend1.getAttribute().compareTo(locationFriend2.getAttribute()) == 0) {
			System.out.println(
					locationFriend1.getName() + " and " + locationFriend2.getName() + " are in the same location.");
		} else {
			System.out.println(
					locationFriend1.getName() + " and " + locationFriend2.getName() + " are in different locations.");
		}
	}
